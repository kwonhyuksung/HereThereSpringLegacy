...
<head>
	...
	<script src="${root}/resources/js/review/write.js"></script>
</head>
<body>
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
				<div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
					<h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">여행 후기 쓰기</h1>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="text p-3">
							<div class="comment-form-wrap">
				                <div class="p-4 bg-light">
				                	<div class="form-group">
				                    	<input type="text" name="postTitle" id="postTitle" class="form-control" placeholder="제목을 입력하세요" ><br>
									</div>
									<hr>
