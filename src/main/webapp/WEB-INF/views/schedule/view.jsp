...
<head>
	...
	var _postSeq = '${scheduleVo.postSeq}';
	var _postUserId = '${scheduleVo.userId}';
	var _loginUserId = '${userInfo.userId}';
	var _adminCode = '${userInfo.adminCode}';
	</script>
	<script src="${root}/resources/js/schedule/view.js"></script>
...
<!-- 페이지 제목과 이미지. 이미지 높이는 js-fullheight로 조정 -->
	<div class="hero-wrap js-fullheight3" style="background-image: url('${root}/resources/images/HereThere_Main_03.JPG');">
				...
				<div class="col-md-12 ftco-animate destination">
					<div class="text p-3">
						<div class="bg-light sidebar-wrap row">
							<div class="col-md-4">
								<img src="${root}/resources/${scheduleVo.savePath}/${scheduleVo.saveName}" alt="" class="img-fluid">
							</div>
							<div class="col-md-8">
								<span class="ml-auto">여행 일정</span>
								<h3 class="mb-3">${scheduleVo.postTitle}</h3>
								<hr>
								<p class="days">
									<span>
										#${scheduleVo.thema}<br>
				...
				<div class="col-md-12 ftco-animate">
					<div class="sidebar-wrap bg-light ftco-animate viewWrap">
						<div class="cnt">
							...
							<div id="hitDiv"><div class="scheduleHit"><h3 class="heading mb-4"><i class="icon-eye"></i> 조회수 ${scheduleVo.hitCount}</h3></div></div>
						</div>
		              	<hr>
<!-- 작성자인 경우 수정/삭제 버튼을 보여준다 -->
<c:if test="${userInfo.userId == scheduleVo.userId}">
		              	<div align="center">
		              		<input type="button" value="일정 수정" class="btn btn-secondary modiDelBtn" onclick="updateSchedulePost();">
		              		<input type="button" value="일정 삭제" class="btn btn-secondary modiDelBtn" onclick="deleteSchedulePost();">
		              	</div>
</c:if>
		            </div>
				</div>
