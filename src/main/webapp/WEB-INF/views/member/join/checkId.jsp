...
<head>
	...
	function verifyId(){
		if(document.getElementById("checkId").value.trim().length == 0) {
			...
			document.formIdCheck.action = "${root}/member/join/checkId.do";
			document.formIdCheck.submit();
	      }
...
<body>
	<div align="center">
		<div class="wrap-login100">
			<form class="login100-form validate-form" name="formIdCheck" method="POST" action="" onsubmit="return false;">
				<input type="hidden" name="act" value="checkId">
				<h2>아이디 중복 검사</h2>
				<br>
				<div class="row">
					<div class="wrap-input100 validate-input" data-validate="Username is reauired" align="left" style="width: 70%">
						<span class="label-input100">아이디</span>
						<input class="input100" type="text" id="checkId" name="checkId" placeholder="아이디를 입력해주세요" onkeypress="if(event.keyCode == 13){verifyId(); return;}"/>
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<div class="idcheckDiv">
						<input type="button" value="검색" class="btn btn-primary" id="btnSearchId" onclick="javascript:verifyId();">
					</div>
				</div>
