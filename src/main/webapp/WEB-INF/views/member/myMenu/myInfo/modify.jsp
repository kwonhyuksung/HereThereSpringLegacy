...
<meta charset="UTF-8">
	...
	function modifyMember() {
		...
		if (document.getElementById("modifyId").value.trim().length == 0) {
			...
			document.getElementById("formModifyMember").setAttribute("action", "${root}/member/myMenu/myInfo/modify.do");
			document.getElementById("formModifyMember").submit();
		}
	}
...
<c:if test="${userInfo == null}">
    ...
    <div class="hero-wrap js-fullheight3" style="background-image: url('${root}/resources/images/HereThere_Main_09.JPG')">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">  
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">내 정보 수정</h1>
          </div>
        </div>
      </div>
    </div>
			...
			<div class="row">
				...
				<div class="col-lg-9" align="center">
					<div class="wrap-login100" style="width: 600px;background: aliceblue;">
						<form class="login100-form validate-form" name="formModifyMember" id="formModifyMember" method="post" action="">
							...
							<div class="wrap-input100 validate-input" data-validate="Password is required" align="left">
								...
								<input class="input100" type="password" id="userPass1" name="userPass1" value="${userInfo.userPass}" placeholder="수정하실 비밀번호를 확인해주세요." readonly="readonly">
								<span class="focus-input100" data-symbol="&#xf191;"></span>
							</div>						
							<div class="changepassDiv" id="chdiv">
								<input type="button" value="비밀번호변경" class="btn btn-primary" id="changepassBtn" onclick="javascript:changePass();">
							</div>
							<br>
							<div class="wrap-input100 validate-input" data-validate="Password is required" align="left">
							...
							<div class="d-flex justify-content-center mb-3">
								<div class="col-lg-5">
									<input type="button" value="수정하기"	class="btn btn-primary" style="width: 70%;"	onclick="javascript:modifyMember();">
								</div>
								<div class="col-lg-5">
									<input type="button" value="취소" class="btn btn-primary" style="width: 70%;" onclick="location.href='${root}/member/myMenu/myInfo/view.do'">
								</div>
							</div>
						</form>
					</div>		       	
