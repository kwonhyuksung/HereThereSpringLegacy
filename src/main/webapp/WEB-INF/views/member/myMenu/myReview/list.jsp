...
<head>
	...
	<script src="${root}/resources/js/member/myMenu/myReview/list.js"></script>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">  
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">내가 작성한 후기</h1>
          </div>
        </div>
      </div>
    </div>
				...
				<div class="col-lg-3 sidebar">
					<div class="sidebar-wrap bg-light ftco-animate">
						<div class="categories">
							...
							<li><a href="${root}/member/myMenu/myReview/mvList.do" class="dropdown-item" style="color:red;">내가 작성한 후기</a></li>							
						</div>
					</div>
				</div>
<!-- 왼쪽 목록 END -->
