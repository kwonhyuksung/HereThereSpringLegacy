...
<head>
	...
	<script src="${root}/resources/js/information/view.js"></script>
...
<body>
	...
	<div class="hero-wrap" style="background-image: url('${root}/resources/images/HereThere_Main_02.JPG'); height: 100px">
	...
	<section class="ftco-section">
		<div class="container">
			<div class="col-lg-12 sidebar ftco-animate">				
				<h3 id="detailViewTitle" class="heading mb-4">여행 정보</h3>				
			</div>				
						...
						<div class="col-md-12 d-flex align-items-center">						  
							<div class="tab-content ftco-animate" id="v-pills-tabContent">							
								...
								<div class="tab-pane fade" id="detailImage" role="tabpanel" aria-labelledby="detailImage-tab">
									<div>										
										<p>
             							<img src="${root}/resources/images/Image_11.jpg" alt="" class="">             							
           								</p>										
									</div>
								</div>
							</div>
