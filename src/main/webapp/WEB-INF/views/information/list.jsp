...
<head>
    ...
    <script src="${root}/resources/js/information/list.js"></script>
...
<%@ include file="/WEB-INF/views/include/nav.jsp"%>	
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('${root}/resources/images/HereThere_Main_02.JPG');">
