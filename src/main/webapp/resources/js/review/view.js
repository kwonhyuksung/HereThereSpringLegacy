...
function updateReviewPost(){
	var result = confirm("수정하시겠습니까?");
	if(result) {
		document.location.href = _contextPath + "/review/mvRewrite.do?postSeq=" + _postSeq;
	}
}
...
function deleteReviewPost(){
	...
	if(result) {
		document.location.href = _contextPath + "/review/delete.do?postSeq=" + _postSeq;
	}
}
